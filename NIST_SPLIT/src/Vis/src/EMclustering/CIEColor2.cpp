...
vector<double> CIEColor2::RGBtoXYZ(double r, double g, double b)
...
vector<double> CIEColor2::XYZtoRGB(double X, double Y, double Z)
 {
    vector<double> result;
	/* tVec2 sRGB_red_xy   = { 0.64f, 0.33f };
    tVec2 sRGB_green_xy = { 0.30f, 0.60f };
...
vector<double> CIEColor2::RGBtoCIEluv(double r, double g, double b)
{ //r, g, b: 0-1
	tVec3 myColor;// = {r, g, b};
...
void CIEColor2::LuvtoXYZ(double L, double u, double v, double &X, double &Y, double &Z)
{
	//L=L*100.0;
...
void CIEColor2::XYZtoLuv(double X, double Y, double Z, double &L, double &u, double &v)
{
...
vector<double> CIEColor2::CIEluvtoRGB(double L, double u, double v)
{
...
void CIEColor2::LCHuvtoRGB(double L, double C, double H, double &r, double &g, double &b)
{   
	double u, v;
...
void CIEColor2::closestLCHuvtoRGB(double L, double C, double H, double &r, double &g, double &b)
{   
	double u, v;
	LCHuvtoLuv(L, C, H, u, v);
	//u = u + 0.19783001, v = v + 0.46831998;
...
/*
vector<double> CIEColor2::getApproximateMSC(double )h
{
...
void CIEColor2::SinglehueSequential(double s, double b, double c, double h)
{
	int N=10;
	vector<double> Pseg;
...
vector<vector<double> > CIEColor2::getP(double s, double b, double c, double h)
{
...
vector<double> CIEColor2::SinglehueSequential_LCH(double t, double s, double b, double c, double h)
{
...
double CIEColor2::RGBtoGrayScale(double r, double g, double b,int flag)
{ 
	if(flag==0)
...
vector<double> CIEColor2::SinglehueSequential(vector<vector<double> > MSCs, double t, double s, double b, double c, double h)
{
	int N=10;
	vector<double> Pseg;
	vector<double> p0(3,0),p1(3,0), p2(3,0), q0(3,0), q1(3,0), q2(3,0);
...
vector<double> CIEColor2::SinglehueSequential(double t, double s, double b, double c, double h)
{
	int N=10;
	vector<double> Pseg;
	vector<double> p0(3,0),p1(3,0), p2(3,0), q0(3,0), q1(3,0), q2(3,0);
...
vector<double> CIEColor2::SinglehueSequential2(double t, double s, double b, double c, double h)
{
	int N=10;
	vector<double> Pseg;
	vector<double> p0(3,0),p1(3,0), p2(3,0), q0(3,0), q1(3,0), q2(3,0);
...
vector<double> CIEColor2::MultiplehueSequential(double t, double s, double b, double c, double &h1, double h, double w)
{
	vector<double> Pseg;
	vector<double> p0(3,0),p1(3,0), p2(3,0), q0(3,0), q1(3,0), q2(3,0);
...
vector<double> CIEColor2::MultiplehueSequential_LCH(double t, double s, double b, double c, double h1, double h, double w)
{
	vector<double> Pseg;
	vector<double> p0(3,0),p1(3,0), p2(3,0), q0(3,0), q1(3,0), q2(3,0);
...
vector<double> CIEColor2::getB(vector<double> b0, vector<double> b1, vector<double> b2, double t)
{
...
vector<double> CIEColor2::getB_1(vector<double> b0, vector<double> b1, vector<double> b2, double v)
{
	vector<double> output;
	output.resize(3);
...
vector<double> CIEColor2::getT(vector<double> p0, vector<double> p1, vector<double> p2, vector<double> q0, vector<double> q1, vector<double> q2, double l)
{
	vector<double> output;
...
vector<double> CIEColor2::getCseg(vector<double> p0, vector<double> p1, vector<double> p2, vector<double> q0, vector<double> q1, vector<double> q2, double t)
{
	vector<double> output;
	if(t<=0.5)
	{
...
vector<double> CIEColor2::getHueColor(double value,double H)
{
	vector<double> RGB;
	RGB = CIEColor2::SinglehueSequential(value, 0.75, 0.0, 1.00, H);
	//cerr<<RGB[0]<<" ";

	return RGB;
}
vector<double> CIEColor2::getSpiralColor(double value, double s, double bb, double c,double H1, double H2, double contrast)
{
	if( H1>H2 )
		H2 = H2+360;
	...
	{
	     RGB = CIEColor2::SinglehueSequential(value, s, bb, c, H);	     
	}
	return RGB;
}


vector<double> CIEColor2::getSpiralColor(vector<vector<double> > MSCs, double value, double H1, double H2)
{
	if( H1>H2 )
		H2 = H2+360;
	...
	double r, g, b;	
	//closestLCHuvtoRGB(value*100, 200, H, r, g, b);
	vector<double> RGB = CIEColor2::SinglehueSequential(MSCs, value, 0.75, 0.0, 1.00, H);
	//vector<double> RGB;	RGB.push_back(r); RGB.push_back(g); RGB.push_back(b);
	return RGB;
}

vector<double> CIEColor2::getSpiralTrace(double value, double H1, double H2)
{
	if( H1>H2 )
		H2 = H2+360;
	...
	double r, g, b;	
	//closestLCHuvtoRGB(value*100, 200, H, r, g, b);
	vector<double> LCH = CIEColor2::SinglehueSequential_LCH(value, 0.75, 0., 1., H);
	//vector<double> RGB;	RGB.push_back(r); RGB.push_back(g); RGB.push_back(b);
	return LCH;
}

vector<double> CIEColor2::dividingLCHuvforRGB(double L, double C1, double C2, double H)
{   
	double u, v;
	vector<double> RGB;
...
double CIEColor2::dividingLCHuvforMSC_C(double L, double C1, double C2, double H)
{   
	double u, v;
	vector<double> RGB;
	if(L==100 || L==0)
...
/*
vector<vector<double>> CIEColor2::get3600MSC(QString fileName) //get most MSC, compute them if they are not stored
{
    //search all files
...
vector<double> CIEColor2::dividingLCHuvforMSC_H(double L1, double L2, double H)
{	
	if( L1>L2 )
	{
	   swap(L1,L2);
...
vector<double> CIEColor2::MSC(float h)
{//h: 0-360;
    //Corners of RGB cube
...
/*double CIEColor2::dividingLCHuvforC(double L, double C1, double C2, double H)
{   
	double u, v;
	vector<double> RGB;
...
vector<double> CIEColor2::dividingLCHuvforL(double L1, double L2, double H)
...
void CIEColor2::LuvtoLCHuv(double L, double u, double v, double &C, double &H)
{
	L = L;
	C = sqrt(u*u+v*v);
...
void CIEColor2::LCHuvtoLuv(double L, double C, double H, double &u, double &v)
{
